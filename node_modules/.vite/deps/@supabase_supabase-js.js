...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./browser-V2CCMWH4.js").then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var WebSocket_default = import_ws.default;
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-V2CCMWH4.js")).Response;
  }
  return Response;
});
...
var SupabaseClient = class {
  ...
  _listenForAuthEvents() {
    return __awaiter8(this, void 0, void 0, function* () {
      return yield this.auth.onAuthStateChange((event, session) => {
        setTimeout(() => __awaiter8(this, void 0, void 0, function* () {
          return yield this._handleTokenChanged(event, "CLIENT", session === null || session === void 0 ? void 0 : session.access_token);
        }), 0);
      });
    });
  }
